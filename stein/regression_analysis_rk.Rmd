...
mAll <- lmer(wordDur.Ms.log10 ~ 1 + (1|speakerID) + (1|wordID) + 
                ...
                prior_all.z,
              data=df, REML = FALSE, 
              control=lmerControl(calc.derivs=FALSE, optimizer = 'bobyqa', optCtrl=list(maxfun=2e9)))

mSplit <- lmer(wordDur.Ms.log10 ~ 1 + (1|speakerID) + (1|wordID) + 
                n_segments.z + n_syllables.z + 
                speakerGender.f.sc + interviewerGender.f.sc + speakerAge.f.sc +
                wordPOS.tc.z + global_sr.z +
...
#### Iteration one
```{r}
mBase <- lmer(wordDur.Ms.log10 ~ 1 + (1|speakerID) + (1|wordID) + 
                n_segments.z + n_syllables.z + 
                speakerGender.f.sc + interviewerGender.f.sc + speakerAge.f.sc +
                wordPOS.tc.z + global_sr.z 
              , data=df, REML = FALSE, 
...
mActCont <- lmer(wordDur.Ms.log10 ~ 1 + (1|speakerID) + (1|wordID) + 
                n_segments.z + n_syllables.z + 
                speakerGender.f.sc + interviewerGender.f.sc + speakerAge.f.sc +
                wordPOS.tc.z + global_sr.z +
...
mActSyll <- lmer(wordDur.Ms.log10 ~ 1 + (1|speakerID) + (1|wordID) + 
                n_segments.z + n_syllables.z + 
                speakerGender.f.sc + interviewerGender.f.sc + speakerAge.f.sc +
                wordPOS.tc.z + global_sr.z +
